...
Tanto para Hombres como para Mujeres, aproximadamente el 85.91% de sus observaciones tienen valores faltantes en la columna Total, lo que representa el 28.64% del total de observaciones en el dataframe. Para la categoría Total, el 41.97% de sus observaciones tienen valores faltantes, representando el 13.99% del total de observaciones en el dataframe. Por tanto, no tiene sentido incluir en el análisis obervaciones de hombres y mujeres por separado y se decidió trabajar con ambos sexos juntos.
